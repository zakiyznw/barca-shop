...
from main.views import show_json_by_id, show_main, show_product, show_xml, show_json, show_xml_by_id, show_json_by_id, add_product, rate_product, add_stock, reduce_stock, get_products_json
...
urlpatterns = [
    ...
    path("products/json_ajax/", get_products_json, name="products_json_ajax"),
]
